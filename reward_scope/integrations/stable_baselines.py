...
class RewardScopeCallback(BaseCallback):
    ...
    def export_alerts(self, path: str, format: Optional[str] = None) -> None:
        ...
        Example:
            callback.export_alerts("alerts.json")  # Auto-detect JSON format
            callback.export_alerts("alerts.csv", format="csv")  # Explicit CSV format
        """
    ...
    def export_episode_history(self, path: str, format: Optional[str] = None) -> None:
        ...
        Example:
            callback.export_episode_history("episodes.json")  # Auto-detect JSON format
            callback.export_episode_history("episodes.csv", format="csv")  # Explicit CSV format
        """
